...
export function HowWeMet()
{
    return (
        <div className="legacy-page">
            ...
            <div className="media">
                <img className="mr-3" alt="Jack surveys the post move landscape" src={AmplifiedJack} width="512" height="384" />
                <div className="media-body">
                    ...
                    <p>We're now finally getting everything unpacked, but the move didn't exactly go 
                        smoothly.&nbsp; On moving day, Paul had a 102&deg; temperature.&nbsp; Fortunately, 
            ...
            <div className="media">
                <img className="mr-3 mt-3" alt="Jack and Pearl getting ready for a rumble" src={JackAndPearl} width="406" height="333" />
                <div className="media-body mt-3">
                    <h2>Pearl and Jack</h2>
